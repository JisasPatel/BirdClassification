...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 21 20:41:05 2023
...
st.title('Bird Classification (525 classes)')
...
def load_model():
    model = tf.keras.models.load_model('EfficientNetB0_For_birdClassification.h5')
    return model
...
def read_image_from_file_uploader(file_uploader):
    # Check if a file was uploaded
    
    if file_uploader is not None:
        
        # Read the BytesIO object and convert it to a numpy array
...
if file is not None:
    image = read_image_from_file_uploader(file)
    st.image(image,caption ="Classifing Image", use_column_width=True,width = 10)
    label = classify(image,model,classes)
